...
p. @{"error":"This account doesn't exist"}@
p. @{"error":"Not allowed to delete an account if you're not ADMIN"}@
...
p. @{"success":"Participation confirmed"}@

p. Errors:

p. @{"error":"Participation already confirmed"}@

p. @{"error":"Not allowed to confirm"}@

p. @{"error":"This participation doesn't exist"}@
